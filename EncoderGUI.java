...
public class EncoderGUI extends JFrame {
    ...
    private JButton compressButton, compressedSizeButton, compressionRatioButton,
                    ...
                    showSizeButton, showBytes, compressBits, compBytes, exportCsvButton;
    ...
    public EncoderGUI() {
        ...
        JButton[] buttonArray = { compressButton, compressedSizeButton,
                ...
                compressBits, compBytes, exportCsvButton };
    ...
    private void compressButtonActionPerformed(ActionEvent evt) {
        ...
        // After successful compression, store history in the database
        try {
            java.io.File originalFile = new java.io.File(src);
            java.io.File compressedFile = new java.io.File(dst);

            long originalSize = originalFile.exists() ? originalFile.length() : 0L;
            long compressedSize = compressedFile.exists() ? compressedFile.length() : 0L;

            double compressionRatio = 0.0;
            if (originalSize > 0 && compressedSize > 0) {
                compressionRatio = ((double) (originalSize - compressedSize) / (double) originalSize) * 100.0;
            }
            ...
            DatabaseManager.insertCompressionRecord(
                    fileName,
        ...
        if(!path.isEmpty()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        "Failed to decompress file.\nMake sure you selected a file created by this app.\nError: " + e.getMessage(),
                        "Decompression Error",
                        JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void exportCsvButtonActionPerformed(ActionEvent evt) {
        JFileChooser chooser = new JFileChooser();
        chooser.setDialogTitle("Save Compression History CSV");
        int userSelection = chooser.showSaveDialog(this);
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            boolean exported = DatabaseManager.exportHistoryToCsv(path);

            File csvFile = new File(path);
            if (exported && csvFile.exists()) {
                JOptionPane.showMessageDialog(null,
                        "Compression history exported to:\n" + path,
                        "Export Successful",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null,
                        "Failed to export compression history.\n" +
    ...
    private void initComponents() {
        ...
        exportCsvButton.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        exportCsvButton.setText("Export History CSV");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        ...
                                                        .addComponent(exportCsvButton, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(compressedSizeButton)
                                        .addComponent(showSizeButton)
